  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        "focus-visible:ring-[3px] focus-visible:outline-1 focus-visible:ring-ring/50 focus-visible:outline-ring",
        "disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
        
        // 💛 Asegura que el color activo se vea
        "data-[state=active]:text-yellow-400 data-[state=active]:border-yellow-400",
        
        // 🎨 Colores base (cuando NO está activo)
